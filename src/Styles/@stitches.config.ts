...
export const {
    ...
    utils:{
        ...
        "imgBg":()=>({
            width:"100%",
            height:"100%",
            backgroundImage:"url('https://www.theglobeandmail.com/resizer/ho6wHklL-ohj-cr3t2wvGGCP-eg=/1200x800/filters:quality(80)/cloudfront-us-east-1.images.arcpublishing.com/tgam/IJF6E37AZBGEVPPC75C6ICZF4A.jpg')",
